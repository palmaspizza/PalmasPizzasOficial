...
document.querySelector("#submit").addEventListener("click", e => {e.preventDefault();
  ...
  *${formadepago}*%0A%0A
  ...
  ${formatopizzas}
  ${pizzas}%0A
  ${cantidaditaliana}+${pizzaitaliana}+${tamañoitaliana}%0A
  ${cantidadhawaiana}+${pizzahawaiana}+${tamañohawaiana}%0A
  ${cantidadnapolitana}+${pizzanapolitana}+${tamañonapolitana}%0A
  ${cantidadsuperpepperoni}+${pizzasuperpepperoni}+${tamañosuperpepperoni}%0A
  ${cantidadvegetariana}+${pizzavegetariana}+${tamañovegetariana}%0A
  ${cantidadlucopizza}+${pizzalucopizza}+${tamañolucopizza}%0A
  ${cantidadcheeseburger}+${pizzacheeseburger}+${tamañocheeseburger}%0A
  ${cantidadpollobbq}+${pizzapollobbq}+${tamañopollobbq}%0A
  ${cantidadchillian}+${pizzachillian}+${tamañochillian}%0A
